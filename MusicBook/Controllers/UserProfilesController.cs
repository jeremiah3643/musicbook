...
namespace MusicBook.Controllers
{
    public class UserProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserProfileId,FirstName,LastName,Location,Experience")] UserProfile userProfile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserProfileId,FirstName,LastName,Location,Experience")] UserProfile userProfile)
        {
